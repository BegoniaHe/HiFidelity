...
class MiniPlayerWindowController: NSWindowController, NSWindowDelegate {
    ...
    convenience init() {
        ...
        if let savedOrigin = Self.loadWindowPosition() {
            ...
            let positionX = screenRect.maxX - windowRect.width - 20
            let positionY = screenRect.minY + 20
    ...
    private static func loadWindowPosition() -> NSPoint? {
        ...
        let positionX = CGFloat(UserDefaults.standard.double(forKey: "miniPlayerWindowX"))
        let positionY = CGFloat(UserDefaults.standard.double(forKey: "miniPlayerWindowY"))
